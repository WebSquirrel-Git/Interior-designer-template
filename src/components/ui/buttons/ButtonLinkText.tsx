...
export const ButtonLinkText=({url,label}:ButtonLinkTextProps)=>{
    ...
    return <Link href={url} className='group flex flex-row gap-[10px] w-max'>
        <span className='group-hover:text-white transition-all duration-500 lg:text-[24px] text-[16px] font-semibold text-accent whitespace-nowrap'>{label}</span>
