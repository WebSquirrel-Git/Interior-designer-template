...
export const RealizationCard=({header,surface,style,year}:RealizationCardProps)=>{

    return <div className='relative sm:h-[380px] h-[450px] w-full border-accent border-[2px]'>
        <Image src={BgImg} fill alt='2' className='object-cover'/>
        <div className="absolute inset-0 bg-black/40 z-10 flex flex-col justify-between content-between">
