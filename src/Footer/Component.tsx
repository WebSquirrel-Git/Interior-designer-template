...
<div className='flex flex-col gap-[10px]'>
  ...
  {typeof informations !== 'number' && informations?.company &&<p>{informations.company}</p>}
   {typeof informations !== 'number' && informations?.town  && informations?.street &&<p>{informations.town}{" "}{informations.street}</p>}
  ...
  {typeof informations !== 'number' && informations?.email &&
  <span className='flex flex-row gap-2'>
    <Image src={MailIcon} alt='mail' width={24} height={24}/>
    <p>{informations.email}</p>
    </span>}
   {typeof informations !== 'number' && informations?.phone &&<span className='flex flex-row gap-2'>
